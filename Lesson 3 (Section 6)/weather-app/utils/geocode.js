...
const geocode = (address, callback) => {
    const url  = `https://api.mapbox.com/search/geocode/v6/forward?q=${encodeURIComponent(address)}&access_token=pk.eyJ1IjoieXZpY3RvcjAiLCJhIjoiY200ZzBqeTY0MG9mZDJrcHB0MGFxb2pmYyJ9.vY4L1VSM1O5-6cyPdn_VkQ`
